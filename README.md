...
- 📸 **一键截图识别**：点击悬浮窗相机图标，自动截图并发送给 AI 分析
- 🤖 **智能内容识别**：
  - 题目自动解答（选择题、填空题、问答题等）
  - 代码错误分析与修复建议
  - 文档内容快速总结
...
1. 打开应用，点击"启动悬浮窗"按钮
2. 授予悬浮窗权限和屏幕录制权限
3. 切换到需要识别的界面（如题目、代码、文档等）
4. 点击悬浮窗的相机图标截图
5. 等待 AI 分析结果，答案将显示在悬浮窗中
...
├── CaptureActivity.kt           # 截图捕获 Activity
├── service/
...
2. **前台服务**：截图功能依赖前台服务，请确保允许应用后台运行
3. **网络连接**：AI 分析需要网络连接
4. **API 费用**：使用真实 AI API 会产生相应费用
